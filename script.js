// AUTOMATION
import headlines from '/finalDa.json' with { type: 'json' };
...
$(".news").click(function(e) {
    if($(this).hasClass("ETnews")){
        appendModal("NEW YORK TIMES", headlines["ET"], "https://www.nytimes.com/section/todayspaper");
    }
    else if($(this).hasClass("THnews")){
        appendModal("USA TODAY", headlines["Hindu"], "https://www.usatoday.com");
    }
    else if($(this).hasClass("HTnews")){
        appendModal("THE MERCURY", headlines["HT"], "https://www.themercury.com.au/");
    }
    else if($(this).hasClass("TOInews")){
        appendModal("DAILY HERALD", headlines["TOI"], "https://www.dailyherald.com/");
    }
});
